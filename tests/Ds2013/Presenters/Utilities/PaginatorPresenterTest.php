    ...
    public function paginationDataProvider(): array
    {
        return [
            ...
            'six-pages-2' => [
                ...
                'per-page' => 10,
                'total' => 60,
                'expected-pages' => [1, 2, 3, 4, 5, 'spacer-mobile', 6],
            ],
            'six-pages-3' => [
                'current-page' => 3,
                'per-page' => 10,
            ...
            'six-pages-4' => [
                ...
                'per-page' => 10,
                'total' => 60,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6],
            ],
            'six-pages-5' => [
                'current-page' => 5,
                'per-page' => 10,
            ...
            'seven-pages-3' => [
                ...
                'per-page' => 10,
                'total' => 62,
                'expected-pages' => [1, 2, 3, 4, 5, 6, 'spacer-mobile', 7],
            ],
            'seven-pages-4' => [
                'current-page' => 4,
                'per-page' => 10,
                'total' => 62,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 'spacer-mobile', 7],
            ],
            'seven-pages-5' => [
                'current-page' => 5,
                'per-page' => 10,
                'total' => 62,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 7],
            ],
            'seven-pages-6' => [
                'current-page' => 6,
                'per-page' => 10,
            ...
            'eight-pages-4' => [
                ...
                'per-page' => 10,
                'total' => 79,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 7, 'spacer-mobile', 8],
            ],
            'eight-pages-5' => [
                'current-page' => 5,
                'per-page' => 10,
            ...
            'nine-pages-4' => [
                ...
                'per-page' => 10,
                'total' => 85,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 'spacer', 9],
            ],
            'nine-pages-5' => [
                'current-page' => 5,
                'per-page' => 10,
                'total' => 85,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 7, 8, 'spacer-mobile', 9],
            ],
            'nine-pages-6' => [
                'current-page' => 6,
                'per-page' => 10,
                'total' => 85,
                'expected-pages' => [1, 'spacer', 4, 5, 6, 7, 8, 'spacer-mobile', 9],
            ],
            'nine-pages-7' => [
                'current-page' => 7,
                'per-page' => 10,
            ...
            'ten-pages-4' => [
                ...
                'per-page' => 10,
                'total' => 100,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 'spacer', 10],
            ],
            'ten-pages-5' => [
                'current-page' => 5,
                'per-page' => 10,
                'total' => 100,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 7, 'spacer', 10],
            ],
            'ten-pages-6' => [
                'current-page' => 6,
                'per-page' => 10,
                'total' => 100,
                'expected-pages' => [1, 'spacer', 4, 5, 6, 7, 8, 9, 'spacer-mobile', 10],
            ],
            'ten-pages-7' => [
                'current-page' => 7,
                'per-page' => 10,
                'total' => 100,
                'expected-pages' => [1, 'spacer', 5, 6, 7, 8, 9, 'spacer-mobile', 10],
            ],
            'ten-pages-8' => [
                'current-page' => 8,
                'per-page' => 10,
            ...
            'eleven-pages-4' => [
                ...
                'per-page' => 10,
                'total' => 110,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 'spacer', 11],
            ],
            'eleven-pages-5' => [
                'current-page' => 5,
                'per-page' => 10,
                'total' => 110,
                'expected-pages' => [1, 'spacer-mobile', 2, 3, 4, 5, 6, 7, 'spacer', 11],
            ],
            'eleven-pages-6' => [
                'current-page' => 6,
                'per-page' => 10,
            ...
            'eleven-pages-7' => [
                ...
                'per-page' => 10,
                'total' => 110,
                'expected-pages' => [1, 'spacer', 5, 6, 7, 8, 9, 10, 'spacer-mobile', 11],
            ],
            'eleven-pages-8' => [
                'current-page' => 8,
                'per-page' => 10,
                'total' => 110,
                'expected-pages' => [1, 'spacer', 6, 7, 8, 9, 10, 'spacer-mobile', 11],
            ],
            'eleven-pages-9' => [
                'current-page' => 9,
                'per-page' => 10,
