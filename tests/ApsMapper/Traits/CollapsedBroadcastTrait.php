...
namespace Tests\App\ApsMapper\Traits;
...
trait CollapsedBroadcastTrait
{
    ...
    private function formatDateTime(DateTimeImmutable $dateTimeImmutable): string
    {
        ...
        return ($dateTimeImmutable->getOffset())
            ? $dateTimeImmutable->format(DATE_ATOM) // 2002-10-19T21:00:00+01:00
            : $dateTimeImmutable->format('Y-m-d\TH:i:s\Z'); // 2016-02-01T21:00:00Z
    }
}
